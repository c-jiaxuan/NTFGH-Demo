...
export class MainMenuView extends BaseView {
    ...
    constructor(id)
    {
        ...
        this.buttons = {
            ...
            txt2Img : this.element.querySelector('#text2img-button'),
            txt2Vid : this.element.querySelector('#text2vid-button'),
            img2Vid  : this.element.querySelector('#img2vid-button'),
            doc2Vid : this.element.querySelector('#doc2vid-button'),
            url2Vid  : this.element.querySelector('#url2vid-button'),
        }
    ...
    setLanguage(lang) {
        ...
        this.buttons.txt2Img.querySelector('.button-text').textContent = this.labels[lang].text2Img;
        this.buttons.txt2Vid.querySelector('.button-text').textContent = this.labels[lang].text2Vid;
        this.buttons.img2Vid.querySelector('.button-text').textContent = this.labels[lang].img2Vid;
        this.buttons.doc2Vid.querySelector('.button-text').textContent = this.labels[lang].doc2Vid;
        this.buttons.url2Vid.querySelector('.button-text').textContent = this.labels[lang].url2Vid;
